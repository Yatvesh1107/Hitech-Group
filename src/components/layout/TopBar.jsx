...
function TopBar() {
  return (
    <div className="bg-[#041B39] h-10 text-white text-[13px]">
      <div className="mx-auto h-full max-w-[1280px] flex items-center justify-between px-5 md:px-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <a
            href="https://www.facebook.com/share/1986DAgA1r/?mibextid=wwXIfr"
            aria-label="Facebook"
            className="hover:text-[#F4B400] transition-colors"
          >
            <svg viewBox="0 0 24 24" fill="currentColor" className="w-[15px] h-[15px]">
          ...
          <a
            href="https://www.instagram.com/hitechinsulation?igsi=MXduNG9wMXpjZGV5dA%3D%3D"
