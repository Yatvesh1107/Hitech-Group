...
import { LayoutDashboard, Users, Package, FileText, Settings, LogOut, X, ChevronDown } from "lucide-react"
...
const navItems = [
  ...
  { to: "/admin/products", label: "Products & Services", icon: Package, end: false },
]
